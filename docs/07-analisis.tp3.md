...
## 1. ¿Qué resolvimos?
Modificamos la conexion de "busqueda por titulo" del menu con arbol Binario de Busqueda, antes la busqueda recorria la lista de Peliculas una por una, ahora las Peliculas se cargan en el arbol. 

## 2. Clave de ordenamiento
El usuario busca por título, así que ordenamos por título para que la búsqueda sea directa.
